...
// This also gives the Bear more than one "Reason to change" - If how the journal entry system works is updated, then we have to go in to our Bear class and change it, we already have to change the Bear class if any of its Bear stuff changes, that's two reasons to change, bad.
